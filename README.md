...
- [`drq_explicit.py`](https://github.com/dietmarwo/drq_fast_mars/blob/master/src/drq_explicit.py) Simplified DRQ using only explicit mutation operators, multi-warrior scoring.
